Implementa un nuevo feature usando el método Test-Driven Development (TDD) y el formato específico para asegurarte de que el componente o función se desarrolle de manera efectiva en React.
